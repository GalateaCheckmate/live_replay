...
# Some live stream endpoints still use plain HTTP FLV/HLS. Keep mobile
# behavior aligned with the desktop recorder rather than rejecting the source.
...
print("Android runtime tuning applied")
